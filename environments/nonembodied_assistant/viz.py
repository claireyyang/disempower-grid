...
def render(state: State, env: NonEmbodiedMultiAgentGridWorld, cell_size: int = 100) -> chex.Array:
    """
...
def create_frame_data(state: State, env: NonEmbodiedMultiAgentGridWorld):
    return {
...
def create_trajectory_viewer_px(
    ...
    HelperActionsEnum = create_helper_actions_enum(num_boxes, no_freeze)
